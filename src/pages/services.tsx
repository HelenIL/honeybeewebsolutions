...
export default function Services() {   
  ...
  <div className="flip-card-inner ">
    ...
    <div className="flip-card-back" style={{alignContent: 'center', textAlign: 'center'}}>
      <p className="flip-card-p">We believe great websites start with thoughtful design and intentional development. Every site we create is uniquely designed to reflect your brand, tell your story, and stand out from the crowd—never built from generic templates.
<br/>
<br/>
